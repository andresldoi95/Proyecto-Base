...
public class CosechasTerminadasActivity extends AppCompatActivity {
    ...
    private CosechasTerminadasAdapter cosechasTerminadasAdapter;
    ...
    private void exportar() {
        cosechasTerminadasAdapter = (CosechasTerminadasAdapter) lvCosechas.getAdapter();
    ...
    private void selectAll(){
        ...
        for (int i = 0; i < cosechasTerminadasAdapter.getCount(); i++) {
            Cosecha cosecha = (Cosecha) cosechasTerminadasAdapter.getItem(i);
            cosecha.seleccionado = true;
            cosechas.add(cosecha);
        }
        cosechasTerminadasAdapter.clear();
        cosechasTerminadasAdapter.addAll(cosechas);
        cosechasTerminadasAdapter.notifyDataSetChanged();
    }
