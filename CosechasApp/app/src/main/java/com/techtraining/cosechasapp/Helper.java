...
public class Helper {
    //public static final String URL_API = "http://10.0.2.2:8000/api";
    //public static final String URL_OAUTH2 = "http://10.0.2.2:8000/oauth/token";
    //http://38.123.149.8
    ...
    //public static final String CLIENT_SECRET = "oFlPysSiwkL5wOp2T2ruCVHjd1zX4T4Ja8wPN6db";
    //XbEO8Ol48yp67UQrw0L4sbQSrmNKxFGaRwzplHKL
